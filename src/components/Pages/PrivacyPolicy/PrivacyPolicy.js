        ...
        return (
            <div>
                ...
                <SimpleBar style={{ height: '100vh'}} forceVisible="y" autoHide={false}>
                    ...
                    <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Malcom Baatjies.</p>
                    </li>
                    <li>
                    ...
                    <li>
                    <p><strong>Website</strong> refers to Malcom Baatjies, accessible from <a href="https://malcolmbaatjies.me" rel="external nofollow noopener noreferrer" target="_blank">https://malcolmbaatjies.me</a></p>
                    </li>
                    <li>
                    ...
                    <h1>Contact Us</h1>
                    <p>If you have any questions about this Privacy Policy, You can contact us on our contact page.</p>
                    </div>
                    <Footer></Footer>
                </SimpleBar>
            </div>
